...
class Config:
    ...
    MODEL_URL = 'https://bacbonschool.s3.ap-south-1.amazonaws.com/uploads/e-Teachers_Guide/breast_ultrasound_cnn_model.h5'
    MODEL_PATH = 'breast_ultrasound_cnn_model.h5'
    IMAGE_SIZE = (128, 128)
